  ...
  render: () => {
    ...
    return (
      <div style={{ overflowX: "auto" }}>
        <style>{`
          .tui-force-hover .tui-checkbox__indicator { border-color: var(--tui-color-brand-black-500); }
          .tui-force-hover .tui-checkbox--primary .tui-checkbox__indicator { border-color: var(--tui-color-brand-pink-600); }
          ...
          .tui-force-hover .tui-checkbox--white .tui-checkbox__indicator { border-color: var(--tui-color-brand-black-300); }
          .tui-force-hover .tui-checkbox--black .tui-checkbox__indicator { border-color: var(--tui-color-brand-black-900); }
